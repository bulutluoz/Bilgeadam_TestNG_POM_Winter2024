...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-sonuclari/Rapor"+date+".html";
        ...
        extentReports.setSystemInfo("Automation Engineer", "Reyhan Gunduz");
        extentHtmlReporter.config().setDocumentTitle("Testotomasyon testleri");
    ...
    // Raporlandırmayı sonlandırmak icin en sonda 1 kez calisir
